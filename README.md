...
|                         软件或文件                          |                                                                        获取方法                                                                         |
|:------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------:|
|     mindspore-2.2.10-cp37-cp37m-linux_aarch64.whl      |     [获取链接](https://ms-release.obs.cn-north-4.myhuaweicloud.com/2.2.10/MindSpore/unified/aarch64/mindspore-2.2.10-cp37-cp37m-linux_aarch64.whl)      |
|      mindspore-2.2.10-cp37-cp37m-linux_x86_64.whl      |      [获取链接](https://ms-release.obs.cn-north-4.myhuaweicloud.com/2.2.10/MindSpore/unified/x86_64/mindspore-2.2.10-cp37-cp37m-linux_x86_64.whl)       |
|     Ascend-mindxdl-elastic_5.0.0_linux-aarch64.zip     |           [获取链接](https://ascend-repo.obs.cn-east-2.myhuaweicloud.com/MindX/MindX%205.0.0/Ascend-mindxdl-elastic_5.0.0_linux-aarch64.zip)            |
|     Ascend-mindxdl-elastic_5.0.0_linux-x86_64.zip      |            [获取链接](https://ascend-repo.obs.cn-east-2.myhuaweicloud.com/MindX/MindX%205.0.0/Ascend-mindxdl-elastic_5.0.0_linux-x86_64.zip)            |
...
|  torch_npu-1.11.0.post8-cp37-cp37m-linux_aarch64.whl   |        [获取链接](https://gitee.com/ascend/pytorch/releases/download/v5.0.rc3-pytorch1.11.0/torch_npu-1.11.0.post4-cp37-cp37m-linux_aarch64.whl)        |
|   torch_npu-1.11.0.post8-cp37-cp37m-linux_x86_64.whl   |        [获取链接](https://gitee.com/ascend/pytorch/releases/download/v5.0.rc3-pytorch1.11.0/torch_npu-1.11.0.post4-cp37-cp37m-linux_x86_64.whl)         |
...
|        Ascend-cann-kernels-910_7.0.0_linux.run         |                [获取链接](https://ascend-repo.obs.cn-east-2.myhuaweicloud.com/CANN/CANN%207.0.0/Ascend-cann-kernels-910_7.0.0_linux.run)                |
|        Ascend-cann-kernels-910b_7.0.0_linux.run        |               [获取链接](https://ascend-repo.obs.cn-east-2.myhuaweicloud.com/CANN/CANN%207.0.0/Ascend-cann-kernels-910b_7.0.0_linux.run)                |
|        Ascend-cann-nnrt_7.0.0_linux-aarch64.run        |               [获取链接](https://ascend-repo.obs.cn-east-2.myhuaweicloud.com/CANN/CANN%207.0.0/Ascend-cann-nnrt_7.0.0_linux-aarch64.run)                |
|        Ascend-cann-nnrt_7.0.0_linux-x86_64.run         |                [获取链接](https://ascend-repo.obs.cn-east-2.myhuaweicloud.com/CANN/CANN%207.0.0/Ascend-cann-nnrt_7.0.0_linux-x86_64.run)                |
|      Ascend-cann-tfplugin_7.0.0_linux-aarch64.run      |             [获取链接](https://ascend-repo.obs.cn-east-2.myhuaweicloud.com/CANN/CANN%207.0.0/Ascend-cann-tfplugin_7.0.0_linux-aarch64.run)              |
|      Ascend-cann-tfplugin_7.0.0_linux-x86_64.run       |              [获取链接](https://ascend-repo.obs.cn-east-2.myhuaweicloud.com/CANN/CANN%207.0.0/Ascend-cann-tfplugin_7.0.0_linux-x86_64.run)              |
|      Ascend-cann-toolkit_7.0.0_linux-aarch64.run       |              [获取链接](https://ascend-repo.obs.cn-east-2.myhuaweicloud.com/CANN/CANN%207.0.0/Ascend-cann-toolkit_7.0.0_linux-aarch64.run)              |
|       Ascend-cann-toolkit_7.0.0_linux-x86_64.run       |              [获取链接](https://ascend-repo.obs.cn-east-2.myhuaweicloud.com/CANN/CANN%207.0.0/Ascend-cann-toolkit_7.0.0_linux-x86_64.run)               |
|      Ascend-mindx-toolbox_5.0.0_linux-aarch64.run      |            [获取链接](https://ascend-repo.obs.cn-east-2.myhuaweicloud.com/MindX/MindX%205.0.0/Ascend-mindx-toolbox_5.0.0_linux-aarch64.run)             |
|      Ascend-mindx-toolbox_5.0.0_linux-x86_64.run       |             [获取链接](https://ascend-repo.obs.cn-east-2.myhuaweicloud.com/MindX/MindX%205.0.0/Ascend-mindx-toolbox_5.0.0_linux-x86_64.run)             |
...
|    h5py-3.1.0-cp37-cp37m-manylinux2014_aarch64.whl     |    [获取链接](https://ascend-repo.obs.cn-east-2.myhuaweicloud.com/MindX/OpenSource/python/packages/h5py-3.1.0-cp37-cp37m-manylinux2014_aarch64.whl)     |
